...
Route::group(['middleware' => ['jwt.auth'], 'namespace' => 'App\Http\Controllers\User\Profile'], function($router){
    Route::get('/user-profiles', 'IndexController')->middleware('transform.boolean');
...
// user-profiele-statuses
Route::group(['middleware' => ['jwt.auth'], 'namespace' => 'App\Http\Controllers\User\Profile\Status'], function($router){
    Route::get('/user-profile/statuses', 'IndexController');
});

// user-profiele-careers
Route::group(['middleware' => ['jwt.auth'], 'namespace' => 'App\Http\Controllers\User\Profile\Career'], function($router){
    Route::get('/user-profile/careers', 'IndexController');
});

// user-profiele-categories
Route::group(['middleware' => ['jwt.auth'], 'namespace' => 'App\Http\Controllers\User\Profile\Categorie'], function($router){
